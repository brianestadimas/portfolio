    ...
    <Card sx={{ minHeight: "490px", height: "100%" }}>
      ...
      <VuiBox lineHeight={1.25}>
        ...
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              I used to build my own LLM model
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              I know the terms of "finetuning"
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              I make a specific GPT app (or use API)
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox mb="6px">
        ...
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              Chatgpt is limited for me in specific finding (like job, friends, etc)
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
            I am using chatgpt atleast once a day
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox display="flex" mb="14px">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              I rely on chatgpt for my daily work
            </VuiTypography>
          </VuiBox>
        </VuiBox>
        <VuiBox display="flex">
          ...
          <VuiBox width="80%" ml={2}>
            <VuiTypography variant="button" fontWeight="regular" color="text">
              For me, I like the interface/design of chatgpt web
            </VuiTypography>
          </VuiBox>
        </VuiBox>
      </VuiBox>
